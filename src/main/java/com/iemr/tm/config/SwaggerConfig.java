 ...
 * .apis(RequestHandlerSelectors.basePackage("com.iemr.tm.controller")).build().
 * apiInfo(metaData()); }
 * 
 * private ApiInfo metaData() { ApiInfo apiInfo = new ApiInfo("TM API",
 * "The AMRIT Telemedicine (TM) Service improves Health and Wellness Centers (HWCs) by offering remote healthcare, making it easier for patients to access medical advice and services without visiting in person."
