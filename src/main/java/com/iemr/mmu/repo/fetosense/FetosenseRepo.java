...
//	public int updateFetosenseDetails(@Param("partnerName") String partnerName,
//			@Param("fetosensePartnerID") String fetosensePartnerID,
//			@Param("fetosenseMotherID") String fetosenseMotherID, @Param("testId") String testId,
//			@Param("deviceId") String deviceId, @Param("testDoneAt") String testDoneAt,
//			@Param("lengthOfTest") Integer lengthOfTest, @Param("basalHeartRate") Integer basalHeartRate,
//			@Param("accelerationsListDB") String accelerationsListDB,
//			@Param("decelerationsListDB") String decelerationsListDB,
//			@Param("shortTermVariationBpm") String shortTermVariationBpm,
//			@Param("shortTermVariationMilli") Integer shortTermVariationMilli,
